...
With this project you'll be building an exciting full-stack MERN app.
...
#### Trello Board - Due Tuesday, 07/04/2022
...
### Project Presentations - Monday, 07/11/2022:
...
## Project 3 Assessment (TBD)

You MAY be assigned a Project 3 Assessment (TBD)

Passing the project assessment may be a requirement of the project itself.

The goal of this project's assessment will be to gauge your ability to develop a minimal full-stack MERN application that:
